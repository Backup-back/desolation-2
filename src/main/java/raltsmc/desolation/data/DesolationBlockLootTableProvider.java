...
public class DesolationBlockLootTableProvider extends FabricBlockLootTableProvider {
  ...
  public void generate() {
    ...
    addDrop(DesolationBlocks.CHARRED_DOOR, BlockLootTableGenerator::doorDrops);
    ...
    addDrop(DesolationBlocks.CHARRED_SLAB, BlockLootTableGenerator::slabDrops);
    addDrop(DesolationBlocks.CHARRED_SOIL);
    addDrop(DesolationBlocks.CHARRED_STAIRS);
    addDrop(DesolationBlocks.CHARRED_TRAPDOOR);
    addDrop(DesolationBlocks.CINDERFRUIT_PLANT, block -> cropDrops(block,
